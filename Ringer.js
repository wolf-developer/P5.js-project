let tokenData = { "hash": "0xd5d8a71854af38ebfb10c4c16d1f21dd626a8d319729b3cee9ec9a91c6d1359f", "tokenId": "13000003" }
...
function draw() {
     ...
     circle_show();
    setTimeout(circle_line,300*(index));
    setTimeout(circle_show1,300*(index++));
    setTimeout(strong_show,300*(index++));
    setTimeout(fill_show,300*(index++));
    ...
    function fill_show(){
     ...
     function circle_show(){
          ...
          let l = r === g,
               c = l ? ps.hlCol : p;
          setTimeout(function(){stroke(ps[n(161)])
                                fill(c)},300*(index++));
          let a = 2 * s.r;
          if (ps[n(141)] && s[n(175)] && s.r >= 2 * e && (a *= .4),setTimeout(function() { circle(s.cx, s.cy, a)}, 300 * (index++)), ps[n(180)]) {
               noStroke();
               let t, c = 0,
                    i = p == ps[n(161)] && !l;
